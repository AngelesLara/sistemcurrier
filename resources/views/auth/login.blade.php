                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Acceso al sistema | NOVO MARKET</h3>
                                </div>
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <form action="/login" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input autofocus autocomplete="off" value="jean@gmail.com" class="form-control" name="email" id="inputEmail" type="email" placeholder="name@example.com" />
